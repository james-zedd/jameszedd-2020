        ...
        <section className="contact">
            ...
            <div className="contact__items text-center">
                <span className="contact__item github">
                    <a href="https://github.com/james-zedd" target="_blank" rel="noreferrer">
                        <Github />
                    </a>
                </span>
                <span className="contact__item linkedin">
                    <a href="https://www.linkedin.com/in/jameszedd/" target="_blank" rel="noreferrer">
                        <Linkedin />
                    </a>
                </span>
                <span className="contact__item github">
                    <a href="https://www.instagram.com/jameszedd/" target="_blank" rel="noreferrer">
                        <Instagram />
                    </a>
                </span>
            </div>
